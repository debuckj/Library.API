...
namespace Library.API.Services
{
    public class LibraryRepository : ILibraryRepository
    {
        ...
        public PagedList<Author> GetAuthors(AuthorsResourceParameters authorsResourceParameters)
        {
            ...
            {
                // trim & ignore casing
                var searchQueryForWherClause = authorsResourceParameters.SearchQuery.Trim().ToLowerInvariant();

                collectionBeforePaging = collectionBeforePaging
                    .Where(a => a.Genre.ToLowerInvariant().Contains(searchQueryForWherClause)
                    || a.FirstName.ToLowerInvariant().Contains(searchQueryForWherClause)
                    || a.LastName.ToLowerInvariant().Contains(searchQueryForWherClause));
            }
